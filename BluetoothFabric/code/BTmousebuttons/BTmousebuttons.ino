/*
 ...
 This sketch uses a simple analog input (knitted stretch sensor)
...
void loop()
{ 
  int buttonReading = analogRead(buttonA);
  ...
  //{
    ...
    if (buttonReading <= 512) {
      ...
      bluetooth.write((byte)0);
    } else if (buttonReading > 512){ // send mouse up
      bluetooth.write(0xFD); // start byte
      bluetooth.write(0x5);
      bluetooth.write(0x2);
      bluetooth.write((byte)0);
